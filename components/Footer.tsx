      ...
      <div className="lp-container grid grid-cols-1 md:grid-cols-4 gap-16">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="mb-8 p-4 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-4">
            <div className="shrink-0 w-12 h-12 bg-lp-gold/20 rounded-full flex items-center justify-center border border-lp-gold/40">
              <svg className="w-7 h-7 text-lp-gold" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/>
              </svg>
            </div>
            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-lp-gold leading-tight">Service-Disabled Veteran</p>
              <p className="text-[9px] font-bold text-lp-white-off/40 uppercase tracking-tighter">Owned Small Business (SDVOSB)</p>
            </div>
          </div>

          <div className="flex items-center gap-6">
            <a href="#" aria-label="Twitter" className="text-lp-gold hover:text-lp-white-off transition-colors">
            ...
            <a href="#" aria-label="LinkedIn" className="text-lp-gold hover:text-lp-white-off transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-bold">
            ...
            <li><Link to="/case-studies" className="hover:text-lp-gold transition-colors">Success Simulations</Link></li>
            <li><Link to="/resources" className="hover:text-lp-gold transition-colors">Compliance Library</Link></li>
            <li><Link to="/faq" className="hover:text-lp-gold transition-colors">Common Questions</Link></li>
